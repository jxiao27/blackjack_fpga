...
HD_PWD='C:/cs233H_labs/blackjack/blackjack.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Master_FSM.tcl -notrace
