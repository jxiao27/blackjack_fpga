...
HD_PWD='C:/cs233H_labs/blackjack/blackjack.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Master_FSM.tcl
